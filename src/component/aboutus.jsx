...
const About = () => {
  return (
    <section className="grid w-full lg:h-96 items-center px-6 py-2 md:px-32 lg:py-12 lg:px-44 border border-black">
      <h2 className="font-Lora text-3xl mt-8 lg:mb-10">
        About Diagnosis <span className="text-dark-rose">DBD</span>
      </h2>
      <p className="font-Inter lg:mb-10 lg:w-1/2 md:text-lg">
  ...
  <li className="relative bg-blue-100 p-10 rounded-xl flex items-start">
    <div className="grid grid-cols-2 gap-4 w-full">
      <div>
        <span className="text-4xl text-gray-800 block font-Lora">20M+</span>
        <span className="text-lg text-gray-500 font-Inter">
